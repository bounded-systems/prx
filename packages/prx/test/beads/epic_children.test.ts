...
// GH-1011 flipped findEpicChildren's default source to Front Desk. These tests
// exercise the bd door/runner path, so pin them to bd (restored per-test). The
// "Front Desk source" describe below manages the env itself.
