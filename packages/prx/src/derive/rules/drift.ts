...
const AUX: Rule[] = [
  ...
  rule(
    "pr_headref_matches_branch",
    atom("pr_headref_matches_branch", v("I")),
    [
  ...
  rule(
    "worktree_branch_matches",
    atom("worktree_branch_matches", v("I")),
    [
  ...
  rule(
    "sync_remote_fresh_aligned",
    atom("sync_remote_fresh_aligned", v("I")),
    [
...
const I01: Rule[] = [
  ...
  rule(
    "drift_i01_no_branch_row",
    atom("drift", v("I"), c("I01")),
    [
...
const BRANCH_PRESENT: Rule = rule(
  "branch_present",
  atom("branch_present", v("I")),
  [atom("branch", v("I"), v("_bn"), v("_bl"), v("_br"), v("_hl"), v("_hr"), v("_ah"), v("_bh"))],
);

const I02: Rule[] = [
  rule(
    "drift_i02_headref_mismatch",
    atom("drift", v("I"), c("I02")),
    [
      atom("pr", v("I"), c(true), v("_n"), v("_s"), v("_d"), v("_h"), v("_a")),
...
const I03: Rule[] = [
  rule(
    "drift_i03_branch_mismatch",
    atom("drift", v("I"), c("I03")),
    [
...
const I05: Rule[] = [
  rule(
    "drift_i05_worktree_exists",
    atom("drift", v("I"), c("I05")),
    [
...
const I06: Rule = rule(
  "drift_i06_overflow",
  atom("drift", v("I"), c("I06")),
  [atom("ci_required_overflow", v("I"))],
);

const I07: Rule = rule(
  "drift_i07_passed_but_incomplete",
  atom("drift", v("I"), c("I07")),
  [atom("ci_passed_but_incomplete", v("I"))],
);

const I08: Rule = rule(
  "drift_i08_sha_mismatch",
  atom("drift", v("I"), c("I08")),
  [
    atom("sync", v("I"), c(true)),
