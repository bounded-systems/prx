...
const inReviewToReadyToMerge: TransitionContract = transitionContractSchema
  .parse({
    axis: "workflow",
    fromPhase: "in_review",
...
export const transitionRegistry: Readonly<Record<string, TransitionContract>> =
  Object.freeze(
...
export function getTransitionContract(
  key: string,
): TransitionContract | undefined {
