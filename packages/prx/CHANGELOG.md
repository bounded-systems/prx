...
- dffb52f: Retire the home verbs: `prx home update`, `prx home sync`, and `prx upgrade` are
  ...
  different flake, the guessed dir still evaluates, so the switch _succeeds_ while
...
- 96707fe: Mount the door fabric at a host-agnostic in-container path (`guestDoorDir`,
...
- 7b46886: Relicense prx from `PolyForm-Noncommercial-1.0.0` to `MIT`, completing the #669
